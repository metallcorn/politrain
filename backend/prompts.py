...
LEXICAL_EXERCISES_PROMPT = (
    ...
    "  Выбирай СЛОВАРНУЮ форму — инфинитив для глаголов, именительный ед.ч. для существительных\n"
    "- ЗАПРЕЩЕНО: падежные формы как отдельные карточки (czasu, kawy, domu) — только базовая форма (czas, kawa, dom)\n"
    "- ЗАПРЕЩЕНО: притяжательные конструкции типа 'jej sukienka', 'mój dom' — только отдельные слова или настоящие идиомы\n"
