...
- "polish": ОДНО слово в словарной форме или ОДНА устойчивая фраза. Словарная форма — ОБЯЗАТЕЛЬНО:
  существительное → именительный падеж единственного числа (не мн.ч.! не род.п.!)
  глагол → инфинитив (czytać, nie czyta/czytał)
  прилагательное → мужской род им.пад. ед.ч. (nowy, nie nowej/nowych)
  ЗАПРЕЩЕНО: auta (мн.ч. от auto), psów (род.п. от pies), nowej (не муж.р.) — только базовая форма
  Не ставь несколько форм через / — выбирай одну
- "translation_ru": если слово имеет несколько равнозначных переводов — перечисли через ' / '. Точный перевод: mama=мама, matka=мать, ojciec=отец, tata=папа — не путай формальные и разговорные слова. Но не смешивай разные значения многозначного слова — выбирай наиболее типичное
"""
