...
const CHANGELOG = [
  {
    id: '2026-08-07',
    title: 'Экзамен и мелочи по ощущениям',
    items: [
      'Экзамен грузится как обычные задания — с прогрессом и статусами, а не пустым спиннером.',
      'Тексты экзамена стали длиннее и на уровень выше, а вопросы — на понимание и вывод, а не «найди фразу в тексте».',
      'В конце сессии показываем, сколько ошибок ты исправил во втором шансе.',
      'Баннер второго шанса стал коротким — «Ещё один шанс · +½ XP».',
    ],
  },
  {
    id: '2026-08-06',
    title: 'Достижения и «Испытай себя»',
    items: [
      '78 достижений: за опыт, серию дней, слова, задания, время, уровни. Получил новое — покажем отдельным экраном с похвалой прямо в занятии.',
      'Исправили подсчёт: достижения за слова теперь считаются от реального числа слов, которыми ты пользуешься.',
      'На главной — «Испытай себя»: пробный экзамен по польскому в стиле сертификата, чтобы проверить уровень без риска.',
      'Задания экзамена теперь проходят те же проверки качества, что и обычные упражнения — без кривых вопросов и неверных ответов.',
      'В профиле достижения стали компактными: недавние + ближайшие цели, а весь список — по ссылке «Смотреть все».',
    ],
  },
  {
    id: '2026-08-05',
    title: 'Работа над ошибками в конце сессии',
    items: [
      'Ошибся по ходу занятия? В конце дадим второй шанс исправить — одна попытка на каждое. Верный ответ = +половина опыта.',
      'Задание всё равно вернётся на повторение позже — второй шанс просто помогает лучше запомнить сразу.',
    ],
  },
  {
    id: '2026-08-04',
    title: 'Уровень повышается сам',
    items: [
      'Больше никакого потолка: как только освоишь ≥80% тем следующего уровня, приложение автоматически повысит тебя (A2 → B1 → B2). Никаких экзаменов — твой прогресс и есть твой уровень.',
      'Шкала прогресса теперь показывает путь к твоему следующему уровню (не только к B1).',
      'Пока берёшь новый уровень — задания жёстко фокусируются на его темах, чтобы быстрее его закрыть.',
    ],
  },
  {
    id: '2026-08-03',
    title: 'Лестница до B2',
    items: [
      'Добавили 8 тем уровня B2: причастия, страдательный залог, отглагольные существительные, сложные условные, словообразование, устойчивые сочетания, формальный стиль, тонкости вида. Теперь есть куда расти после B1.',
    ],
  },
  {
    id: '2026-07-30',
